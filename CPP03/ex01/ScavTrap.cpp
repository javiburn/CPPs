...
/*   Updated: 2023/11/27 17:28:04 by jsarabia         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ScavTrap::attack(const std::string& target){
	if (this->energy < 1){
		std::cout << "ScavTrap " << this->name << " is getting some well deserved rest" << std::endl;
		return;
	}
	if (this->hp < 1){
		std::cout << "ScavTrap " << this->name << " was defeated and can not move!" << std::endl;
		return;
	}
